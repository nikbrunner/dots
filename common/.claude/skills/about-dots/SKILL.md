...
Nik's symlink-based dotfiles management system. Configs live in a git repo and are symlinked to their expected home directory locations, supporting both macOS and Arch Linux.
...
Also contains Nik's Claude Code configuration (skills, hooks, agents) which is symlinked to `~/.claude/`.
