...
- [Claude statusline & cache](claude_statusline_and_cache.md) — bash statusline (no node: it saturates Gatekeeper), cache TTL 1h personal/5m work, PreCompact can't inject compact instructions
