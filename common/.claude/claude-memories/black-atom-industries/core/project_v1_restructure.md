---
name: V1 Scope Restructure
description: V1 scope expanded to include livery, dates moved to sub-projects, theme finalization consolidated
type: project
---

V1 scope expanded from "core themes + adapters + branding" to include livery as a key differentiator.
