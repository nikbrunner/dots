...
Weekly reflection practice. Two modes: Quick Capture or full Reflection.
...
- Challenge gently but firmly. Call out imposter syndrome.
- Hold space for both voices (critic vs patient friend).
- Don't rush to solutions. Sitting with the feeling has value.
- Use his own words from journals.
...
- Bring up family/Thomas unprompted
- Compare to therapy
...
Add wikilink in monthly journal + checked task `[x]` in daily note.

### Update memory

Any meaningful observations about his state, patterns, or ongoing threads.
