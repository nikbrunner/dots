...
| Dev skills to load | `dev:style:react`, `dev:style:css`, `dev:style:state`, `dev:style:tanstack`     |
...
| -------------- | ----------------------------------------------------------------------- |
| Any TypeScript | `dev:style:typescript`                                                  |
| React          | `dev:style:react`, `dev:style:css`, `dev:style:state`                   |
| TanStack usage | `dev:tanstack`, `dev:tanstack-query`, `dev:tanstack-form` (as relevant) |
| Any project    | `dev:style:tdd`, `dev:flow propose`                                     |
