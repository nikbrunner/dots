...
Launch **parallel subagents** (3-5 agents) to find semantic connections between highlights from _different_ sources. Each agent should analyze a batch of highlights and return connections.
...
>
> - "{highlight A snippet}" ↔ "{highlight B snippet}" — _{connection label}_
> - ...
>
