-- Deferred via `Edit.later`: every entry point is a <leader>-prefixed
-- keymap or a picker invoked on demand — none fire on the first frame.
-- The keymaps register ~1 frame after paint (vim.schedule), well before
