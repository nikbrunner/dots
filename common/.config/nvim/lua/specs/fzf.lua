...
M.keys = function()
    ...
    local fre = require("fzf-lua-frecency")
    ...
    return {
        {
            ...
            function()
                fre.frecency({
                    winopts = M.winopts.left_corner,
                    -- winopts = M.winopts.fullscreen.tab,
                    cwd_only = true,
                })
            end,
            desc = "[D]ocument",
        ...
        --     "<leader>wr",
        --     function()
        --         fzfLua.oldfiles({ cwd_only = true, prompt = "Recent Files (CWD): ", winopts = M.winopts.fullscreen.tab })
        --     end,
        ...
        -- { "<leader>wt",       function() fzfLua.live_grep({ winopts = M.winopts.md.vertical }) end, desc = "[T]ext" },
        {
            "<leader>wm",
            function()
                fzfLua.git_status({ winopts = M.winopts.fullscreen.tab })
            end,
            desc = "[M]odified Documents",
        },
